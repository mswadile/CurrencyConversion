...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2024 at 07:51 PM
...
ALTER TABLE `exchangerates`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `base_currency` (`base_currency`,`target_currency`,`date`),
  ADD KEY `base_currency_2` (`base_currency`),
